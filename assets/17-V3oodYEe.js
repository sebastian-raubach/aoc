const e=`You finally decode the Elves' message. \`HI\`, the message says. You continue searching for the sleigh keys.
...
**How many distinct initial velocity values cause the probe to be within the target area after any step?**`;export{e as default};
