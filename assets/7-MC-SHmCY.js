const n=`You thank the cephalopods for the help and exit the trash compactor, finding yourself in the [familiar](https://adventofcode.com/2024/day/6) [halls](https://adventofcode.com/2018/day/4) of a North Pole research wing.
...
Apply the many-worlds interpretation of quantum tachyon splitting to your manifold diagram. **In total, how many different timelines would a single tachyon particle end up on?**`;export{n as default};
